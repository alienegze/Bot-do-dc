//Ukradnięte z https://github.com/ezelkow1/discord-key-bot/blob/master/embed.go
package main
...
func SendEmbed(s *discordgo.Session, channelID string, title string, fieldTitle string, field string) {
	if title != "" {
		embed := NewEmbed().
			...
			SetFooter("Twój Osobisty Niewolnik zosatał ufundowany przez pierwiastek z Czech").
...
func (e *Embed) SetFooter(args ...string) *Embed {
	...
	iconURL := "https://cdn.discordapp.com/app-icons/809146312226242610/b92385392c73a7efb44771dc7edda54f.png?size=256"
	text := "Twój Osobisty Niewolnik zosatał ufundowany przez pierwiastek z Czech :flag_cz:"
	proxyURL := ""
